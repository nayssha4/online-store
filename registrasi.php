...
<html>
    ...
    <body>
    <img src="bgpinkconverse.jpg" class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="var(--bs-secondary-color)"/></img>
          <div class="filter">
        </div>
            <div class="container">
                <h1>Register</h1>
                  <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="button">
                    <button class="btn-hover color-9"type="submit" name="login" >
                        Register        
                </button>
                    </div>
                </form>
