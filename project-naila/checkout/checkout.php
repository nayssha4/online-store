    ...
    <div class="row g-5">
      <div class="col-md-5 col-lg-4 order-md-last">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">Product name</h6>s
              <small class="text-body-secondary">Deskripsi singkat</small>
            </div>
            <span class="t0ext-body-secondary">$12</span>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
              <label for="namaAwal" class="form-label">Nama awal</label>
              <input type="text" class="form-control" id="namaAwal" placeholder="" value="" required>
            ...
            <div class="col-sm-6">
              <label for="namaAkhir" class="form-label">Nama akhir</label>
              <input type="text" class="form-control" id="namaAkhir" placeholder="" value="" required>
              <div class="invalid-feedback">
          ...
          <div class="row gy-3">
            ...
            <div class="col-md-3">
              <label for="cc-expiration" class="form-label">Kadaluwarsa</label>
              <input type="text" class="form-control" id="cc-expiration" placeholder="" required>
              <div class="invalid-feedback">
                Tanggal kadaluwarsa diperlukan
              </div>
            </div>
